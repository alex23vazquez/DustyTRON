...
if(command =='y')
{
 tiltUp(); // MAX Reverse Aug Speed 3
}

if(command =='t')
{
 tiltDown(); // MAX Reverse Aug Speed 3
}
if(command =='h')
{
 panRight(); // MAX Reverse Aug Speed 3
}
if(command =='g')
{
 panLeft(); // MAX Reverse Aug Speed 3
}
if(command =='b')
{
 resetAll(); // MAX Reverse Aug Speed 3
}
